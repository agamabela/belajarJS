...
import {
    Collapse, Navbar, NavbarBrand, NavbarToggler, Nav, NavItem, NavLink, DropdownItem, DropdownToggle, UncontrolledDropdown, NavbarText, DropdownMenu
